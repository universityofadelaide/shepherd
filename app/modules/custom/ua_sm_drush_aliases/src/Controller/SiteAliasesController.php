...
/**
 * @file
 * Contains Drupal\ua_sm_drush_aliases\Controller\SiteAliasesController.
 */

namespace Drupal\ua_sm_drush_aliases\Controller;
 ...
 * @package Drupal\ua_sm_drush_aliases\Controller
 */
class SiteAliasesController extends ControllerBase {

  public function siteAliases($nid) {
    $node = Node::load($nid);
    $aliases = \Drupal::service('ua_sm_drush_aliases.site_aliases')->generateAliases($node);
    if ($aliases) {
