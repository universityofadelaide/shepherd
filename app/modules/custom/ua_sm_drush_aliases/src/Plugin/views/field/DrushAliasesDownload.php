...
namespace Drupal\ua_sm_drush_aliases\Plugin\views\field;
 ...
 *
 * @package Drupal\ua_sm_drush_aliases\Plugin\views\field
 *
...
class DrushAliasesDownload extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    $url = Url::fromRoute('ua_sm_drush_aliases.drush_aliases', ['nid' => $values->_entity->id()]);
